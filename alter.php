...
{
$catCod = $_POST['catCod'];
$PndClrNam = $_POST['PndClrNam'];
$PndClrCst = $_POST['PndClrCst'];
$PndClrTyp = $_POST['PndClrTyp'];
$qry = "UPDATE `tbpndclr` SET `catCod`= $catCod,`PndClrNam`= '$PndClrNam',`PndClrCst`= '$PndClrCst',`PndClrTyp`= '$PndClrTyp' WHERE `catCod`= $catCod ";
...
<font color="white">
   <br><br> <h1>Update Data</h1><br>
   <br><br>
   <div class="clear">
  <form method="POST" action="#">
    <br>
      <b>  ID</b><input type="text" name="catCod" placeholder="eg 6"><br><br>
  <b>  Name</b><input type="text" name="PndClrNam" placeholder="eg Rent"><br><br>
   <b> Cost</b> <input type="text" name="PndClrCst" placeholder="eg 6546"><br><br>
      <b> Status</b>
      <input type="radio" value="Cleared" name="PndClrTyp">Cleared <input type="radio" value="Pending" name="PndClrTyp">Pending
      <br><br>
          <button type="sumbit" class="add" name="button" onclick="alert('Data has been altered!')"> ADD </button>
        </div>
        </span>
        </font>
        </body>
